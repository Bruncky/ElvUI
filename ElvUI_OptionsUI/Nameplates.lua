...
E.Options.args.nameplate.args.generalGroup.args.plateVisibility = ACH:Group(L["Visibility"], nil, 50)
...
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.showAll.customWidth = 250
...
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility = ACH:Group(L["Player"], nil, 5, nil, function(info) return E.db.nameplates.units.PLAYER.visibility[info[#info]] end, function(info, value) E.db.nameplates.units.PLAYER.visibility[info[#info]] = value NP:SetCVars() NP:ConfigureAll() end)
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility.inline = true
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility.args.showInCombat = ACH:Toggle(L["Show In Combat"], nil, 1, nil, nil, nil, nil, nil, function() return not E.db.nameplates.units.PLAYER.enable or E.db.nameplates.units.PLAYER.visibility.showAlways end)
...
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility.args.spacer1 = ACH:Spacer(3, 'full')
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility.args.hideDelay = ACH:Range(L["Hide Delay"], nil, 4, { min = 0, max = 20, step = .01, bigStep = 1 }, nil, nil, nil, function() return not E.db.nameplates.units.PLAYER.enable or E.db.nameplates.units.PLAYER.visibility.showAlways end)
E.Options.args.nameplate.args.generalGroup.args.plateVisibility.args.playerVisibility.args.alphaDelay = ACH:Range(L["Delay Alpha"], nil, 5, { min = 0, max = 1, step = .01, bigStep = .1 }, nil, nil, nil, function() return not E.db.nameplates.units.PLAYER.enable or E.db.nameplates.units.PLAYER.visibility.showAlways end)
...
E.Options.args.nameplate.args.generalGroup.args.bossMods.args.settings.args.spacing = ACH:Range(L["Spacing"], nil, 4, { min = 6, max = 64, step = 1 }, nil, nil, nil, nil, function() return E.db.nameplates.bossMods.keepSizeRatio end)
E.Options.args.nameplate.args.generalGroup.args.bossMods.args.settings.args.xOffset = ACH:Range(L["X-Offset"], nil, 5, { min = -100, max = 100, step = 1 })
E.Options.args.nameplate.args.generalGroup.args.bossMods.args.settings.args.yOffset = ACH:Range(L["Y-Offset"], nil, 6, { min = -100, max = 100, step = 1 })
E.Options.args.nameplate.args.generalGroup.args.bossMods.args.settings.args.anchorPoint = ACH:Select(L["Anchor Point"], L["What point to anchor to the frame you set to attach to."], 7, C.Values.Anchors)
...
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.personal = ACH:Group(L["Personal"], nil, 1)
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.personal.inline = true
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.personal.args.personalWidth = ACH:Range(L["Clickable Width / Width"], L["Change the width and controls how big of an area on the screen will accept clicks to target unit."], 1, { min = 50, max = 250, step = 1 })
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.personal.args.personalHeight = ACH:Range(L["Clickable Height"], L["Controls how big of an area on the screen will accept clicks to target unit."], 2, { min = 10, max = 75, step = 1 })

E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.friendly = ACH:Group(L["Friendly"], nil, 2)
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.friendly.inline = true
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.friendly.args.friendlyWidth = ACH:Range(L["Clickable Width / Width"], L["Change the width and controls how big of an area on the screen will accept clicks to target unit."], 1, { min = 50, max = 250, step = 1 })
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.friendly.args.friendlyHeight = ACH:Range(L["Clickable Height"], L["Controls how big of an area on the screen will accept clicks to target unit."], 2, { min = 10, max = 75, step = 1 })

E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.enemy = ACH:Group(L["Enemy"], nil, 3)
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.enemy.inline = true
E.Options.args.nameplate.args.generalGroup.args.clickableRange.args.enemy.args.enemyWidth = ACH:Range(L["Clickable Width / Width"], L["Change the width and controls how big of an area on the screen will accept clicks to target unit."], 1, { min = 50, max = 250, step = 1 })
...
E.Options.args.nameplate.args.generalGroup.args.cutaway.args.power.args.lengthBeforeFade = ACH:Range(L["Fade Out Delay"], L["How much time before the cutaway power starts to fade."], 3, { min = .1, max = 1, step = .1 }, nil, nil, nil, function() return not E.db.nameplates.cutaway.power.enabled end)
E.Options.args.nameplate.args.generalGroup.args.cutaway.args.power.args.fadeOutTime = ACH:Range(L["Fade Out"], L["How long the cutaway power will take to fade out."], 4, { min = .1, max = 1, step = .1 }, nil, nil, nil, function() return not E.db.nameplates.cutaway.power.enabled end)

E.Options.args.nameplate.args.generalGroup.args.threatGroup = ACH:Group(L["Threat"], nil, 80, nil, function(info) return E.db.nameplates.threat[info[#info]] end, function(info, value) E.db.nameplates.threat[info[#info]] = value NP:ConfigureAll() end)
E.Options.args.nameplate.args.generalGroup.args.threatGroup.args.enable = ACH:Toggle(L["Enable"], nil, 0)
E.Options.args.nameplate.args.generalGroup.args.threatGroup.args.useThreatColor = ACH:Toggle(L["Use Threat Color"], nil, 1)
E.Options.args.nameplate.args.generalGroup.args.threatGroup.args.beingTankedByTank = ACH:Toggle(L["Color Tanked"], L["Use Tanked Color when a nameplate is being effectively tanked by another tank."], 2, nil, nil, nil, nil, nil, function() return not E.db.nameplates.threat.useThreatColor end)
E.Options.args.nameplate.args.generalGroup.args.threatGroup.args.indicator = ACH:Toggle(L["Show Icon"], nil, 3, nil, nil, nil, nil, nil, function() return not E.db.nameplates.threat.enable end)
...
E.Options.args.nameplate.args.colorsGroup.args.general.args.auraByDispels = ACH:Toggle(L["Borders By Dispel"], nil, 2)
E.Options.args.nameplate.args.colorsGroup.args.general.args.auraByType = ACH:Toggle(L["Borders By Type"], nil, 3)

E.Options.args.nameplate.args.colorsGroup.args.threat = ACH:Group(L["Threat"], nil, 2, nil, function(info) local t, d = E.db.nameplates.colors.threat[info[#info]], P.nameplates.colors.threat[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b, d.a end, function(info, r, g, b, a) local t = E.db.nameplates.colors.threat[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a NP:ConfigureAll() end, function() return not E.db.nameplates.threat.useThreatColor end)
E.Options.args.nameplate.args.colorsGroup.args.threat.inline = true
E.Options.args.nameplate.args.colorsGroup.args.threat.args.goodColor = ACH:Color(L["Good Color"], nil, 1)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.goodTransition = ACH:Color(L["Good Transition Color"], nil, 2)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.badTransition = ACH:Color(L["Bad Transition Color"], nil, 3)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.badColor = ACH:Color(L["Bad Color"], nil, 4)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.offTankColor = ACH:Color(L["Off Tank"], nil, 5, nil, nil, nil, nil, nil, function() return (not E.db.nameplates.threat.beingTankedByTank or not E.db.nameplates.threat.useThreatColor) end)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.offTankColorGoodTransition = ACH:Color(L["Off Tank Good Transition"], nil, 6, nil, nil, nil, nil, function() return (not E.db.nameplates.threat.beingTankedByTank or not E.db.nameplates.threat.useThreatColor) end)
E.Options.args.nameplate.args.colorsGroup.args.threat.args.offTankColorBadTransition = ACH:Color(L["Off Tank Bad Transition"], nil, 7, nil, nil, nil, nil, function() return (not E.db.nameplates.threat.beingTankedByTank or not E.db.nameplates.threat.useThreatColor) end)

E.Options.args.nameplate.args.colorsGroup.args.castGroup = ACH:Group(L["Cast Bar"], nil, 3, nil, function(info) local t, d = E.db.nameplates.colors[info[#info]], P.nameplates.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.nameplates.colors[info[#info]] t.r, t.g, t.b = r, g, b NP:ConfigureAll() end)
E.Options.args.nameplate.args.colorsGroup.args.castGroup.inline = true
E.Options.args.nameplate.args.colorsGroup.args.castGroup.args.castColor = ACH:Color(L["Interruptible"], nil, 1)
E.Options.args.nameplate.args.colorsGroup.args.castGroup.args.castNoInterruptColor = ACH:Color(L["Non-Interruptible"], nil, 2)
E.Options.args.nameplate.args.colorsGroup.args.castGroup.args.castInterruptedColor = ACH:Color(L["Interrupted"], nil, 3)
E.Options.args.nameplate.args.colorsGroup.args.castGroup.args.castbarDesaturate = ACH:Color(L["Desaturated Icon"], L["Show the castbar icon desaturated if a spell is not interruptible."], 4, nil, nil, function(info) return E.db.nameplates.colors[info[#info]] end, function(info, value) E.db.nameplates.colors[info[#info]] = value NP:ConfigureAll() end)

E.Options.args.nameplate.args.colorsGroup.args.selectionGroup = ACH:Group(L["Selection"], nil, 4, nil, function(info) local n = tonumber(info[#info]) local t, d = E.db.nameplates.colors.selection[n], P.nameplates.colors.selection[n] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.nameplates.colors.selection[tonumber(info[#info])] t.r, t.g, t.b = r, g, b NP:ConfigureAll() end)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.inline = true
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['0'] = ACH:Color(L["Hostile"], nil, 0)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['1'] = ACH:Color(L["Unfriendly"], nil, 1)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['2'] = ACH:Color(L["Neutral"], nil, 2)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['3'] = ACH:Color(L["Friendly"], nil, 3)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['5'] = ACH:Color(L["Player"], nil, 5)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['6'] = ACH:Color(L["Party"], nil, 6)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['7'] = ACH:Color(L["Party PVP"], nil, 7)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['8'] = ACH:Color(L["Friend"], nil, 8)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['9'] = ACH:Color(L["Dead"], nil, 9)
E.Options.args.nameplate.args.colorsGroup.args.selectionGroup.args['13'] = ACH:Color(L["Battleground Friendly"], nil, 13)

E.Options.args.nameplate.args.colorsGroup.args.reactions = ACH:Group(L["Reaction Colors"], nil, 5, nil, function(info) local t, d = E.db.nameplates.colors.reactions[info[#info]], P.nameplates.colors.reactions[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.nameplates.colors.reactions[info[#info]] t.r, t.g, t.b = r, g, b NP:ConfigureAll() end)
E.Options.args.nameplate.args.colorsGroup.args.reactions.inline = true
E.Options.args.nameplate.args.colorsGroup.args.reactions.args.bad = ACH:Color(L["Enemy"], nil, 1)
E.Options.args.nameplate.args.colorsGroup.args.reactions.args.neutral = ACH:Color(L["Neutral"], nil, 2)
E.Options.args.nameplate.args.colorsGroup.args.reactions.args.good = ACH:Color(L["Friendly"], nil, 3)
E.Options.args.nameplate.args.colorsGroup.args.reactions.args.tapped = ACH:Color(L["Tagged NPC"], nil, 4, nil, nil, function(info) local t, d = E.db.nameplates.colors[info[#info]], P.nameplates.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.nameplates.colors[info[#info]] t.r, t.g, t.b = r, g, b NP:ConfigureAll() end)
...
E.Options.args.nameplate.args.targetGroup.args.classBarGroup.inline = true
E.Options.args.nameplate.args.targetGroup.args.classBarGroup.args.enable = ACH:Toggle(L["Enable"], nil, 1)
E.Options.args.nameplate.args.targetGroup.args.classBarGroup.args.width = ACH:Range(L["Width"], nil, 2, { min = minWidth, max = MaxWidth('PLAYER'), step = 1 })
